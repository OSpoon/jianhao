<div align="center">
  ...
  <p>实时感知坐姿变化，并以摄像头窗口边框的柔和呼吸灯提示你适时调整。</p>
  <p>
...
它希望把坐姿提醒做得及时、简单，不打断你正在进行的工作：保持自然坐姿完成校准，之后即可开始监测；需要调整时，摄像头窗口边框会以柔和的红黄渐变呼吸提醒，也可开启与呼吸同步的系统默认提示音。
...
| 边框呼吸提醒 | 显示当前姿态状态，并以摄像头窗口边框的柔和红黄渐变呼吸提示需要调整的情况 |
| 同步提示音 | 使用 macOS 或 Windows 当前选择的默认提示音，可在监测设置中关闭或试听 |
